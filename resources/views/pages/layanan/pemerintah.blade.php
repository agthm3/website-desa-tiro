                ...
                <div class="col-lg-8 posts-list">
                    <div class="single-post">
                        <div class="feature-img">
                            <img class="card-img rounded-0" src="{{ url('storage/' . $pemerintah->image) }}">
                        </div>
                    ...
                    <div class="comment-form">
                        ...
                        <form class="form-contact comment_form" action="{{ route('komentar.pemerintah.store') }}"
                            ...
                            <p>
                                <input type="hidden" value="{{ $pemerintah->id }}" name="pemerintah_id">
                            </p>
                            <div class="form-group">
