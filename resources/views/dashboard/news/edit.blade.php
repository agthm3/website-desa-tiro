    ...
    <div class="container-fluid pt-4 px-4">
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <h1>Edit <span class="text-info">{{ $news->title }}</span></h1>
                ...
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="{{ route('dashboard.news.update', $news) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-floating">
                            <textarea class="form-control" name="article" value="{{ $news->article }}" id="floatingTextarea" style="height: 150px"
                                name="article">{{ $news->article }}</textarea>
